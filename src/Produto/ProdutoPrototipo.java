 ...
 * @author Bruno
 */
public class ProdutoPrototipo extends javax.swing.JFrame {

    /**
     * Creates new form produtoPrototipo
     */
    public ProdutoPrototipo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoPrototipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProdutoPrototipo().setVisible(true);
            }
        });
    }
