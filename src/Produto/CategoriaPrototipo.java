 ...
 * @author Bruno
 */
public class CategoriaPrototipo extends javax.swing.JFrame {

    /**
     * Creates new form categoriaPrototipo
     */
    public CategoriaPrototipo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriaPrototipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoriaPrototipo().setVisible(true);
            }
        });
    }
